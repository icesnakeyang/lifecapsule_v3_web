    ...
    return (
        <div>
            <Breadcrumb style={{margin: "20px 0"}} items={[
                ...
                {
                    title:t('AntiProcrastination.antiProcrastination')
                }
            ]}/>
            <div style={{color: themeColor.textHolder}}>{t('AntiProcrastination.antiDelayTile')}</div>
            ...
            <Row gutter={16}>
                <Col xs={24} sm={12} md={12} lg={12} xl={12} xxl={12}>
                    <Card size='small' style={{marginTop: 20, background: themeColor.blockDark, color: themeColor.textLight}}
                          headStyle={{color: themeColor.textHolder}} title={t('AntiProcrastination.yesterday')}>
                        ...
                        <div style={{marginTop: 10, color:themeColor.textHolder}}>{t('AntiProcrastination.tipYesterday')}</div>
                    </Card>
                </Col>
                <Col xs={24} sm={12} md={12} lg={12} xl={12} xxl={12}>
                    <Card size='small' style={{marginTop: 20, background: themeColor.blockDark, color: themeColor.textLight}}
                    ...
                    >
                        ...
                        <div style={{marginTop: 10,color:themeColor.textHolder}}>{t('AntiProcrastination.tipMyThought')}</div>
                    </Card>
                </Col>
            </Row>
            ...
            <Row gutter={16}>
                <Col xs={24} sm={12} md={12} lg={12} xl={12} xxl={12}>
                    ...
                    >
                        ...
                        />
                        <div style={{marginTop: 10, color:themeColor.textHolder}}>{t('AntiProcrastination.tipLongGoal1')}</div>
                ...
                <Col xs={24} sm={12} md={12} lg={12} xl={12} xxl={12}>
                    ...
                    >
                        <Input.TextArea autoSize style={{background: themeColor.blockDark, color: themeColor.textLight}}
                                        ...
                                        value={todayGoal}/>
                        <div style={{marginTop: 10,color:themeColor.textHolder}}>{t('AntiProcrastination.tipTodayGoal')}</div>
                    </Card>
                </Col>
            </Row>
                    ...
                    {addingTask ? (
                        <div
                            ...
                            <Input
                                ...
                                placeholder={t('AntiProcrastination.todoTaskHolder')}
                                onChange={e => {

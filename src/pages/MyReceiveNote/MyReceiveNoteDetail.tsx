    ...
    return (
        <div style={{}}>
            {loading ? (
                ...
                <div>
                    <div style={{}}>
                        <Card style={{background: themeColor.blockDark}} title={sendLog.title}>
                            <div
                                style={{
                            ...
                            <div style={{color: themeColor.textLight, marginTop: 20}}>
                                {t("MyReceiveNote.MyReceiveNoteDetail.content")}
                            </div>
                                    ...
                                    <Row style={{marginTop: 10}} gutter={10}>
                                        <Col style={{display: "flex", alignItems: 'center'}}>
                                            <div style={{color: themeColor.textLight}}>
                                                {t('MyReceiveNote.MyReceiveNoteDetail.decryptionCode')}
                                            </div>
                                        </Col>
                                        <Col>
                                            <Input
                                                placeholder={t('MyReceiveNote.MyReceiveNoteDetail.decryptionCodeHolder')}
                                                onChange={(e) => {
